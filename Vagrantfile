...
Vagrant.configure(2) do |config|
    config.proxy.http  = "http://web-proxy.corp.hpecorp.net:8080"
    config.proxy.https = "http://web-proxy.corp.hpecorp.net:8080"
    config.yum_proxy.http = "http://web-proxy.fc.hp.com:8080"
